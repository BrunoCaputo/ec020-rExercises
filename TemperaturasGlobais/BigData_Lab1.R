...
# Qual a funcao para ver as 6 primeiras linhas do dataframe cidadesbrasil? Ver colunas!
head(cidadesbrasil)
...
cidadesbrasil$Month <- month(cidadesbrasil$dt)   # para extrair o mes deste formato
cidadesbrasil$Year <- year(cidadesbrasil$dt)     # para extrair o ano deste formato

# Qual a funcao para ver as 6 primeiras linhas do dataframe cidadesbrasil? Ver novas colunas!
head(cidadesbrasil)
...
# Vamos criar subsets do dataset cidadesbrasil para essas 3 cidades
...
varginha <- subset(cidadesbrasil, City == 'Varginha')
